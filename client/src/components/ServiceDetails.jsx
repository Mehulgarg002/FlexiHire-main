                            ...
                            type === 1 || type === 2 ?
                                            ...
                                            {type === 1 ?
                                                ...
                                                <div className="service-price-provider">
                                                    ...
                                                    <div className="provider">
                                                        ...
                                                        <img src={data.selectedService.userId.image === 'no-image.png' ? noImage : `http://localhost:3001/ProfilePic/${data.selectedService.userId.image}`} alt="Service provider's profile" />
                                                    </div>
                                                </div>
                                            }
                                            {type === 1 ?
                                ...
                                <>
                                    ...
                                    <div className="service-price-provider">
                                        ...
                                        <div className="provider">
                                            <span>Service Provided By</span>
                                            <img src={data.clientOrderInfo.serviceUserInfo.image === 'no-image.png' ? noImage : `http://localhost:3001/ProfilePic/${data.clientOrderInfo.serviceUserInfo.image}`} alt="Client's profile" />
                                        </div>
                                    </div>
                                    {
                                            ...
                                            <>
                                                <div className="testimonialForm">
                                                    <form onSubmit={e => handleSubmit(e)}>
                                                        <img src={avatar === 'no-image.png' ? noImage : `http://localhost:3001/ProfilePic/${avatar}`} alt="User's profile" />
