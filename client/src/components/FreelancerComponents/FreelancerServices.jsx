          ...
          <div className="section">
            <div className="buttons">
              ...
              <HashLink to={`/dashboard/freelancer/${id}/services/manage`}>
                <button className="manage-button">Manage Services</button>
              </HashLink>
            </div>
            <div className="services-grid">
              {data?.allServices && data.allServices.length !== 0 ? data.allServices.map(service => (
                <div key={service._id} className="service-card">
                  ...
                  <div className="serviceBody">
                    ...
                    <div className="rating-more">
                      ...
                      <HashLink to={`/dashboard/freelancer/${service.userId}/services/show/${service._id}`}>
